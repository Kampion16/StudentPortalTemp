<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default - Copy - Copy.aspx.cs" Inherits="_Default"  enableEventValidation="false"%>
        ...
        <table style="width:1024px; margin-left: 99px;"> 
           ...
           <asp:Button  OnClientClick="window.open('uploadcourse.aspx')"  runat="server"  class="log-btn" Text="Book Event" /><br /><br />
              ...
              <asp:Button ID="vwVenue" class="log-btn"  runat="server" Text="View Venue Bookings" OnClick="vwVenue_Click" /><br /><br />    
                   ...
                   <td>
              <asp:Button ID="Button1" class="log-btn"  runat="server" Text="Add Event Type" OnClick="AddEntry_Click" /><br /><br />                   
               </td>
            ...
            <RowStyle BackColor="#dadfbc" Height="30px"  Wrap="false" />
             ...
             <Columns>
                   <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="_VenueID" DataNavigateUrlFormatString="UpdateVenue.aspx?VenueID={0}" />
